          ...
          <div className="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
            <div className="mb-3 mb-md-0">
              ...
              <p className="mb-0 ">
                ...
                Popper.js, that adds support for transitions, and visibility
                toggling.
              </p>
            </div>
          </div>
      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div id="basic-example" className="mb-4">
            <h3>Basic </h3>
            <p>
              Overlays consist of at least two elements, the &#34;overlay&#34;,
              the element to be positioned, as well as a &#34;target&#34;, the
              element the overlay is positioned in relation to. You can also
              also have an &#34;arrow&#34; element, like the tooltips and
              popovers, but that is optional.
            </p>
          </div>
        ...
        <Col xl={12} lg={12} md={12} sm={12}>
          <div id="overlay-trigger" className="mb-4">
            ...
            <p>
              ...
              or hides, and a few different &#34;trigger&#34; events you can mix
              and match.
            </p>
          </div>
