...
import { fetchDates } from "app/api/get-all-date";
                                            ...
                                            <tbody>
                                                {programs.map((program, index) => (
                                                    <tr key={program.id}>
                                                        ...
                                                        <td>
                                                            {program.status_laporan == "sudah diperiksa" ? <Badge pill bg="primary" className="me-1">SUDAH DIPERIKSA</Badge> : program.status_laporan == "final" ? <Badge pill bg="info" className="me-1">FINAL</Badge> : <Badge pill bg="secondary" className="me-1">DRAFT</Badge>}
                                                        </td>
                                                        <td>
                                                            <Button
