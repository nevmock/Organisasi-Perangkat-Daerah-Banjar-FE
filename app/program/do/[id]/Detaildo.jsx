...
export default function DoForm({ onSubmit }) {
    ...
    const addKolaborator = () => {
        setForm({ ...form, kolaborator: [...form.kolaborator, { nama: "", peran: "" }] });
    };
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Kolaborator</Form.Label>
                                    <Col md={9}>
                                            ...
                                            <Row className="mb-2" key={idx}>
                                                <Col md={5}>
                                                    <Form.Control
                                                        ...
                                                        value={item.nama}
                                                        onChange={e => handleKolaboratorChange(idx, "nama", e.target.value)}
                                                        required
                                                    />
                                                </Col>
                                                <Col md={5}>
                                                    <Form.Control
                                                        ...
                                                        value={item.peran}
                                                        onChange={e => handleKolaboratorChange(idx, "peran", e.target.value)}
                                                        required
                                                    />
                                                </Col>
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Rincian Kegiatan</Form.Label>
                                    <Col md={9}>
                                        <Form.Control
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Capaian Output</Form.Label>
                                    <Col md={9}>
                                        <Form.Control
                                            name="capaian_output"
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Dokumentasi Kegiatan</Form.Label>
                                    <Col md={9}>
                                        <Form.Control
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Kendala</Form.Label>
                                    <Col md={9}>
                                        <Form.Control
                                            as="textarea"
                                            rows={2}
                                ...
                                <Row className="mb-3">
                                    <Form.Label column md={3}>Rekomendasi</Form.Label>
                                    <Col md={9}>
                                        <Form.Control
                                            as="textarea"
                                            rows={2}
